  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true){
        //echo '<button class="btn btn-primary mx-2" data-bs-toggle="modal" data-bs-target="#logoutModal">Logout</button>';
        echo '<a class="btn btn-primary mx-2" href="/forum/partials/_handle_logout.php">Logout</a>';
      }
      else{
